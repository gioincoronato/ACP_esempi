# non cambia nulla in questo approccio per il receiver

# la differenza è che rispetto alla coda il messaggio arriva a tutti i sub
...
if __name__ == "__main__":
    ...
    print("in ascolto su /topic/test")
